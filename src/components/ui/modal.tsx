      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className={`relative flex w-full flex-col overflow-hidden rounded-[14px] border border-stone-200 bg-[#F4EEE4] text-stone-700 shadow-[0_28px_56px_-24px_rgba(24,22,20,0.45)] outline-none dark:border-white/[0.08] dark:bg-[#1A1617] dark:text-stone-200 ${className}`}
          >
            <div className="flex shrink-0 items-start gap-3 px-4 pb-3 pt-4 border-b border-stone-200/50 dark:border-white/5">
              <div className="min-w-0 flex-1">
                <h2
                  id={titleId}
                  className="text-lg font-serif text-[#4B2138] dark:text-[#FACDC5]"
                >
                  {title}
                </h2>
                {description ? (
              ...
              {showClose ? (
                <button
                  ...
                  className="-mr-1 -mt-1 grid size-8 shrink-0 place-items-center rounded-full text-stone-400 outline-none transition-colors duration-150 hover:bg-stone-200 hover:text-stone-700 focus-visible:bg-stone-200 focus-visible:text-stone-700 dark:text-stone-500 dark:hover:bg-white/10 dark:hover:text-stone-100"
                >
                  {CLOSE_ICON}
                </button>
              ) : null}
            ...
            {children ? (
              <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-4 text-[13px] leading-relaxed">
                {children}
              </div>
            ) : null}

            {footer ? (
              <div className="flex shrink-0 items-center justify-end gap-2 border-t border-stone-200/50 px-4 py-3 dark:border-white/5">
                {footer}
              </div>
            ) : null}
          </motion.div>
